...
public class OfficeAdpter extends RecyclerView.Adapter<OfficeAdpter.MyViewHolder>{
    ...
    public OfficeAdpter(Context mContext, List<StationeryResponse.FilteredProductsBean> homekitchenList) {
